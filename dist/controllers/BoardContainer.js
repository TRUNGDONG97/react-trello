...
const _excluded = ["id", "components", "reducerData", "draggable", "laneDraggable", "laneDragClass", "laneDropClass", "style", "onDataChange", "onCardAdd", "onCardUpdate", "onCardClick", "onBeforeCardDelete", "onCardDelete", "onLaneScroll", "onLaneClick", "onLaneAdd", "onLaneDelete", "onLaneUpdate", "editable", "canAddLanes", "laneStyle", "onCardMoveAcrossLanes", "t"],
...
class BoardContainer extends _react.Component {
  ...
  render() {
    const _this$props5 = this.props,
          ...
          t = _this$props5.t,
          otherProps = (0, _objectWithoutProperties2.default)(_this$props5, _excluded);
